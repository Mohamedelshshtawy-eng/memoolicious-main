...
const renderLogoItem = useCallback(
  (item, key) => {
    ...
    const content = isNodeItem ? (
      <span
        ...
        style={item.style} // ← ارتفاع أكبر من style
      >
        {item.node}
      </span>
    ) : (
      <img
        ...
        decoding="async"
        draggable={false}
        style={{ height: item.style?.height ?? `${logoHeight}px` }}
      />
    );
    ...
    return (
      <li
        className={cx(
          'flex-none leading-[1]',
          isVertical ? `mb-[${gap}px]` : `mr-[${gap}px]`, // ← gap مخصص لكل صورة
  ...
  [isVertical, scaleOnHover, logoHeight, gap]
);
